...
<nav class="large-3 medium-4 columns" id="actions-sidebar">
    <ul class="side-nav">
        ...
        <li><?= $this->Html->link(__('Edit Customer'), ['action' => 'edit', $customer->cust_id]) ?> </li>
        <li><?= $this->Form->postLink(__('Delete Customer'), ['action' => 'delete', $customer->cust_id], ['confirm' => __('Are you sure you want to delete # {0}?', $customer->cust_id)]) ?> </li>
