...
class StocksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'mat_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => true, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
            'fk_stocks_materials1_idx' => ['type' => 'index', 'columns' => ['mat_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['stock_id'], 'length' => []],
            'fk_stocks_materials1' => ['type' => 'foreign', 'columns' => ['mat_id'], 'references' => ['materials', 'mat_id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
