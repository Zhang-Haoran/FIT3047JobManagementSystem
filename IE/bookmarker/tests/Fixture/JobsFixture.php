...
class JobsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        '_constraints' => [
            ...
            'fk_jobs_customers1' => ['type' => 'foreign', 'columns' => ['customer_id'], 'references' => ['customers', 'customer_id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_jobs_employees1' => ['type' => 'foreign', 'columns' => ['employee_id'], 'references' => ['employees', 'employee_id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
    ...
    public function init()
    {
        $this->records = [
            [
                ...
                'job_date' => '2018-09-05',
                'booked_date' => '2018-09-05',
                'price' => 1,
                'deposit' => 1,
                'order_detail' => 'Lorem ipsum dolor sit amet, aliquet feugiat. Convallis morbi fringilla gravida, phasellus feugiat dapibus velit nunc, pulvinar eget sollicitudin venenatis cum nullam, vivamus ut a sed, mollitia lectus. Nulla vestibulum massa neque ut et, id hendrerit sit, feugiat in taciti enim proin nibh, tempor dignissim, rhoncus duis vestibulum nunc mattis convallis.',
                'e_arrival_time' => '06:04:03',
                'e_setup_time' => '06:04:03',
                'e_pickup_time' => '06:04:03',
                'e_pickup_date' => '2018-09-05',
