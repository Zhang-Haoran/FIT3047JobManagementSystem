                        ...
                        <div class="tab-pane fade in active" id="job">
                          <div class="tab-content">
                            ...
                            <div class="form-group"><?= $this->Form->control('event_type_id', ['options' => $eventTypes, 'class' => 'form-control','id'=> 'type_html_id']) ?></div>
                                ...
                                <div class="col-lg-6">
                                    <div class="form-group"><?php echo $this->Form->control('e_arrival_time', array('class' => 'form-control','placeholder'=>'Please select expected arrival time','label' => 'Arrive by','type' => 'text','id' => 'e_arrival_datetime'));?></div>
                                    <div class="form-group"><?php echo $this->Form->control('e_setup_time', array('class' => 'form-control','placeholder'=>'Please select expected setup time','label' => 'Setup by','type' => 'text','id' => 'e_setup_datetime'));?></div>
                                    <div class="form-group"><?php echo $this->Form->control('e_pickup_time', array('class' => 'form-control','placeholder'=>'Please select expected pickup time','label' => 'Pickup after','type' => 'text','id' => 'e_pickup_datetime'));?></div>
                                </div>
                          </div>
                          </div>
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-heading">
                                        <h4 class="panel-title">
                                            ...
                                            <button type="button" class="btn btn-info" onclick="addToOrder()" style="display: block;">TRY ME!!!</button>
                                        </h4>
                                    </div>
                                    <div id="collapseOne" class="panel-collapse collapse in" >
                                        <div class="panel-body">
                                    ...
                                    <script>
                                        ...
                                        function test(){
                                            ...
                                            else console.log(testVar);
                                        }

                                        var newStock;

                                        function addToOrder(){
                                            let order = document.getElementById("order-detail");

                                            oldStock = order.value;
                                            if(newStock) {
                                                console.log('error happen before');
                                                order.value = oldStock;
                                            }
