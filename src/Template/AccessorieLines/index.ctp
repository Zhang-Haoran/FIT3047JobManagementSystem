    ...
    <table cellpadding="0" cellspacing="0">
        <thead>
            <tr>
                ...
                <th scope="col"><?= $this->Paginator->sort('accessories_id') ?></th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td class="actions">
                    <?= $this->Html->link(__('View'), ['action' => 'view', $accessorieLine->id]) ?>
                    <?= $this->Html->link(__('Edit'), ['action' => 'edit', $accessorieLine->id]) ?>
                    <?= $this->Form->postLink(__('Delete'), ['action' => 'delete', $accessorieLine->id], ['confirm' => __('Are you sure you want to delete # {0}?', $accessorieLine->id)]) ?>
                </td>
            </tr>
            <?php endforeach; ?>
        </tbody>
