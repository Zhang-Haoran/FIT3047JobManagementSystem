...
class StocksFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'rent_value' => ['type' => 'float', 'length' => 0, 'precision' => 0, 'unsigned' => true, 'null' => true, 'default' => '0000000000000000000000', 'comment' => ''],
        ...
        '_constraints' => [
            ...
            'fk_stocks_materials1' => ['type' => 'foreign', 'columns' => ['accessorie_id'], 'references' => ['accessories', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
