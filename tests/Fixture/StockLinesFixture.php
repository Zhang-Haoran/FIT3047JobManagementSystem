...
class StockLinesFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'stock_num' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
        ...
        '_constraints' => [
            ...
            'fk_stocks_has_jobs_jobs1' => ['type' => 'foreign', 'columns' => ['job_id'], 'references' => ['jobs', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
            'fk_stocks_has_jobs_stocks1' => ['type' => 'foreign', 'columns' => ['stock_id'], 'references' => ['stocks', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
